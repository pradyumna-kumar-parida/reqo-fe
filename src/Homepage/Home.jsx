  ...
  return (
    <main className="grid grid-cols-2 overflow-hidden ">
      <section className="home  ml-50 flex flex-col py-20  ">
        <h1 className="logo text-[#d9ca26]">
          R <span className="reqo">eqo</span>
        </h1>
        <h2 className="text-xl font-bold text-white">
          Chat Only ,{" "}
          <span className="text-[#95d6a4] text-2xl">When Both Agree....</span>
        </h2>
        ...
        <button className="mt-12 bg-[#d9ca26] font-medium text-2xl flex gap-5  items-center self-baseline py-2 px-6 rounded-md cursor-pointer hover:bg-[#95d6a4] hover:scale-105">
          Let's talk today{" "}
